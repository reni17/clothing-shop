...
export const emailSignInStart = (email, password) => createAction(USER_ACTIONS.EMAIL_SIGN_IN_START, {email, password})
...
export const signUpSuccess = (user, additionalDetails) => createAction(USER_ACTIONS.SIGN_UP_SUCCESS, {user, additionalDetails})
